...
class Property(db.Model):
    ...
    base_guests = db.Column(db.Integer, nullable=False, default=2)
    extra_guest_price = db.Column(db.Float, nullable=False, default=0.0)
    capacity = db.Column(db.Integer, nullable=False)
    min_rent_days = db.Column(db.Integer, nullable=False, default=1)
